...
class EmpInfo extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['emp_branch_id', 'emp_reg_no', 'emp_name', 'emp_cnic', 'emp_contact_no', 'emp_dept_id'], 'required'],
            ...
            [['created_at', 'updated_at', 'emp_status', 'created_by', 'updated_by', 'degree_scan_copy', 'emp_cv', 'emp_photo', 'emp_salary_type','barcode','emp_fb_ID','emp_date_of_birth',
               'emp_religion','emp_domicile', 'emp_temp_address', 'emp_father_name', 'emp_perm_address', 'emp_marital_status', 'emp_gender', 'emp_email', 'emp_qualification', 'emp_passing_year', 'emp_institute_name'], 'safe'],
