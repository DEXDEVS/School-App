...
class StdRegistration extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['std_name', 'std_father_name', 'std_DOB', 'std_gender', 'std_permanent_address', 'std_b_form', 'std_district', 'std_religion', 'std_nationality', 'std_tehseel', 'status', 'academic_status'], 'safe'],
