							...
							<table class="table table-hover">
								<thead>
									<tr style="background-color: #337AB7;color: white;">
										...
										<th colspan="2" class="text-center">Marks <?php echo $examDataCond[0]['full_marks']."/".$examDataCond[0]['passing_marks'] ?></th>
									</tr>
								</thead>								<tbody>
									<?php 
									...
									<div class="row">
										...
										<?php if(!empty($marksWeightageDetails)){
												...
												for ($i=0; $i <$countWeightage ; $i++) {
													$weightageTypeId = $marksWeightageDetails[$i]['weightage_type_id'];

													$weightageName = Yii::$app->db->createCommand("SELECT weightage_type_name
														FROM marks_weightage_type 
														WHERE weightage_type_id = '$weightageTypeId'")->queryAll();
											?> 
											<div class="col-md-2">
