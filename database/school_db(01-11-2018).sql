...
INSERT INTO `std_academic_info` (`academic_id`, `std_id`, `class_name_id`, `previous_class`, `passing_year`, `total_marks`, `obtained_marks`, `grades`, `percentage`, `std_total_fee`, `std_fee_discount`, `std_net_fee`, `Institute`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
(1, 3, 7, '3rd', '2017', 505, 500, 'A+', 98, 0, 0, 0, 'DexDevs', '2018-10-10 14:10:59', '0000-00-00 00:00:00', 1, 0),
(2, 1, 9, '5th', '2017', 505, 400, 'A', 89, 0, 0, 0, 'DexDevs', '2018-10-10 14:19:34', '0000-00-00 00:00:00', 1, 0),
(3, 2, 3, 'KG1', '2017', 300, 299, 'A+', 99, 0, 0, 0, 'DexDevs', '2018-10-10 14:20:12', '0000-00-00 00:00:00', 1, 0);
...
(17, 22, 6, '2018-10-31 06:39:51', '0000-00-00 00:00:00', 1, 0);
...
--
ALTER TABLE `std_enrollment_detail`
  MODIFY `std_enroll_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
