...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2018 at 06:18 AM
...
(6, 'Accountant', 'Permanent', '2018-12-07 06:29:32', '0000-00-00 00:00:00', 1, 0);
...
INSERT INTO `emp_info` (`emp_id`, `emp_name`, `emp_father_name`, `emp_cnic`, `emp_contact_no`, `emp_address`, `emp_marital_status`, `emp_gender`, `emp_designation_id`, `emp_branch_id`, `emp_email`, `emp_qualification`, `emp_passing_year`, `emp_institute_name`, `emp_salary`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
(1, 'Nadia Gull', 'Iftikhar Ali', '12345-6787654-3', '+12-345-6789876', 'RYK', 'Single', 'Female', 6, 2, 'nadiagull285@gmail.com', 'BSCS', 2018, 'Superrior College', 50000, '2018-12-07 06:34:28', '0000-00-00 00:00:00', 1, 0),
(2, 'Anas Shafqat', 'M.Shafqat', '31303-1234567-8', '+92-234-5678945', 'ghulshan iqbal', 'Single', 'Male', 4, 2, 'anas@gmail.com', 'BSCS', 2018, 'Superior college', 10000, '2018-12-12 07:46:12', '0000-00-00 00:00:00', 1, 0),
(3, 'Kinza Mustafa', 'Ghulam Mustafa', '45102-1234567-8', '+92-123-4567823', 'Essa Colony', 'Single', 'Female', 4, 2, 'kinza.fatima.522@gmail.com', 'BSCS', 2017, 'IUB', 10000, '2018-12-12 07:47:59', '0000-00-00 00:00:00', 1, 0);
...
(23, 10, 3, 20, '0', 0, 0, '2018-12-12 08:06:37', '0000-00-00 00:00:00', 1, 0);
...
(1, 4, 9, 12, '2018-12-03 08:27:47', 1085, 115, 1085, 0, 'Unpaid', '2018-12-12 04:50:56', '0000-00-00 00:00:00', 1, 0),
(2, 4, 8, 12, '2018-12-03 08:30:44', 1540, 60, 0, 0, 'Unpaid', '2018-12-12 04:51:07', '0000-00-00 00:00:00', 1, 0),
(3, 3, 3, 12, '2018-12-05 12:16:30', 2965, 135, 0, 0, 'Unpaid', '2018-12-12 04:51:17', '0000-00-00 00:00:00', 1, 0),
...
(6, 3, 6, 12, '2018-12-05 12:28:35', 1303, 97, 1303, 0, 'Paid', '2018-12-12 05:10:07', '0000-00-00 00:00:00', 1, 0),
(7, 3, 7, 12, '2018-12-05 12:31:25', 3415, 285, 234, 3181, 'Unpaid', '2018-12-12 06:01:12', '0000-00-00 00:00:00', 1, 0),
(8, 1, 1, 11, '2018-11-01 10:55:26', 1380, 70, 0, 0, 'Unpaid', '2018-12-12 04:51:50', '0000-00-00 00:00:00', 1, 0),
(9, 1, 2, 11, '2018-11-01 11:00:27', 1870, 430, 0, 0, 'Paid', '2018-12-05 06:01:28', '0000-00-00 00:00:00', 1, 0),
(10, 3, 5, 9, '2018-12-12 01:04:07', 20, 60, 0, 0, 'Unpaid', '2018-12-12 08:06:37', '0000-00-00 00:00:00', 1, 0);
...
INSERT INTO `std_attendance` (`std_attend_id`, `teacher_id`, `class_id`, `date`, `student_id`, `status`) VALUES
(10, 1, 3, '2018-12-12 00:00:00', 3, 'L'),
(11, 1, 3, '2018-12-12 00:00:00', 4, 'P'),
(12, 1, 3, '2018-12-12 00:00:00', 5, 'P'),
(13, 1, 3, '2018-12-12 00:00:00', 6, 'P'),
(14, 1, 3, '2018-12-12 00:00:00', 7, 'A'),
(15, 3, 4, '2018-12-12 00:00:00', 8, 'L'),
(16, 3, 4, '2018-12-12 00:00:00', 9, 'P'),
(17, 3, 1, '2018-12-12 00:00:00', 1, 'A'),
(18, 3, 1, '2018-12-12 00:00:00', 2, 'P');
...
--
ALTER TABLE `std_attendance`
  MODIFY `std_attend_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `std_attendance`
  ADD CONSTRAINT `std_attendance_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `emp_info` (`emp_id`),
  ADD CONSTRAINT `std_attendance_ibfk_2` FOREIGN KEY (`class_id`) REFERENCES `std_class` (`class_id`),
...
ALTER TABLE `teacher_subject_assign_detail`
  ...
  ADD CONSTRAINT `teacher_subject_assign_detail_ibfk_6` FOREIGN KEY (`teacher_subject_assign_detail_head_id`) REFERENCES `fee_transaction_head` (`fee_trans_id`);
