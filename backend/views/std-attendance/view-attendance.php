...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="box box-primary">
            <div class="box-header"style="background-color:#001F3F;">      
                <h2 style="color:white;" align="center">Attendance Report</h2>
            </div>
            <div class="box-body">
                <section id="">
                    <div class="row">
                         <div class="col-sm-6 col-md-6">
                            <div class="panel panel-default panel-card">
                                ...
                                <div class="panel-figure">
                                    <img style="border:none;" class="img-responsive img-circle" src="images/class-std3.jpg" />
                                </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="panel panel-default panel-card">
                                ...
                                <div class="panel-figure">
                                    <img style="border:none;" class="img-responsive img-circle" src="images/std.png" />
                                </div>
                                <div class="panel-body text-center">
      ...
      <!-- Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                    <div class="box box-primary">
                        <div class="box-header" style="padding:0px;background-color:#001F3F;">
                            <h3 class="text-center" style="color:white;">Date Wise Class Attendance</h3>
                        </div>
                        <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><i class="glyphicon glyphicon-calendar" style="color:#3C8DBC;"></i> Date</label>
...
<!--Date wise class Modal close -->
  ...
  <div class="modal fade" id="modal2<?php echo $sub_id;?>" role="dialog">
    ...
    <div class="box box-primary">
        <div class="box-header" style="padding:0px;background-color:#001F3F;">
            <h3 class="text-center" style="color:white;">Date Range Wise Class Attendance</h3>
        </div>
        <div class="box-body">
...
<!--Date wise student Modal start -->
  ...
  <div class="modal fade" id="modal3<?php echo $sub_id;?>" role="dialog">
    ...
    <div class="box box-primary">
        <div class="box-header" style="padding:0px;background-color:#001F3F;">
            <h3 class="text-center" style="color:white;">Date Wise Student Attendance</h3>
        </div>
        <div class="box-body">
            <form method="POST" action="./datewise-student-attendance?sub_id=<?php echo $sub_id ?>&class_id=<?php echo $class_id ?>&teacherHeadId=<?php echo $teacherHeadId ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label><i class="glyphicon glyphicon-user" style="color:#3C8DBC;"></i> Select Student</label>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
           <form method="POST" action="./daterangewise-student-attendance?sub_id=<?php echo $sub_id ?>&class_id=<?php echo $class_id ?>&teacherHeadId=<?php echo $teacherHeadId ?>">
                ...
                <div class="row">
                    <div class="col-md-4">
                       <label><i class="glyphicon glyphicon-calendar" style="color:#3C8DBC;"></i> Start Date:</label>
                        <div class="input-group">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar" style="color: #3C8DBC"></i>
                            </div>
                    ...
                    <div class="col-md-4">
                        <label><i class="glyphicon glyphicon-calendar" style="color:#3C8DBC;"></i> End Date:</label>
                        <div class="input-group">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar" style="color: #3C8DBC"></i>
                            </div>
