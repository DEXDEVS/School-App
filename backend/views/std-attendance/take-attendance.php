		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header" style="background-color:#001F3F;color:white;">
					 <h2 class="text-center" style="font-family: georgia;">Class Attendance</h2>
				</div>
				<div class="box-body">
		...
		<div class="col-md-9">
			<div class="box box-primary">
				<div class="box-header" style="padding:3px;">
					<h2 class="text-center" style="font-family: georgia;">Take Attendance</h2><hr style="border-color:#3C8DBC;">
				</div>
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
