...
use backend\models\TeacherSubjectAssignHeadSearch;
...
class TeacherSubjectAssignHeadController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "TeacherSubjectAssignHead #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new TeacherSubjectAssignHead",
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TeacherSubjectAssignHead #".$id,
