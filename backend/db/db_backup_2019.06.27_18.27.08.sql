...
CREATE TABLE IF NOT EXISTS `std_academic_info` (
  ...
  CONSTRAINT `std_academic_info_ibfk_1` FOREIGN KEY (`std_id`) REFERENCES `std_personal_info` (`std_id`),
  CONSTRAINT `std_academic_info_ibfk_2` FOREIGN KEY (`class_name_id`) REFERENCES `std_class_name` (`class_name_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `std_class_name` (
  ...
  `class_type` enum('School','College','Academi','madrisa') NOT NULL,
  `status` enum('Active','Inactive') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `created_by` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `std_enrollment_head` (
  ...
  KEY `section_id` (`section_id`),
  KEY `branch_id` (`branch_id`),
  CONSTRAINT `std_enrollment_head_ibfk_1` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`branch_id`),
  CONSTRAINT `std_enrollment_head_ibfk_2` FOREIGN KEY (`class_name_id`) REFERENCES `std_class_name` (`class_name_id`),
  CONSTRAINT `std_enrollment_head_ibfk_3` FOREIGN KEY (`section_id`) REFERENCES `std_sections` (`section_id`),
  CONSTRAINT `std_enrollment_head_ibfk_4` FOREIGN KEY (`session_id`) REFERENCES `std_sessions` (`session_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
...
('1','5','5','2019-06-26','10:55:31','','P','3','0','2019-06-26 10:55:31','0000-00-00 00:00:00');;;
INSERT INTO `emp_attendance` (`att_id`,`branch_id`,`emp_id`,`att_date`,`check_in`,`check_out`,`attendance`,`created_by`,`updated_by`,`created_at`,`updated_at`) VALUES
('2','5','1','2019-06-26','11:07:12','','P','1','0','2019-06-26 11:07:12','0000-00-00 00:00:00');;;
INSERT INTO `emp_attendance` (`att_id`,`branch_id`,`emp_id`,`att_date`,`check_in`,`check_out`,`attendance`,`created_by`,`updated_by`,`created_at`,`updated_at`) VALUES
('3','5','2','2019-06-26','11:07:38','','P','1','0','2019-06-26 11:07:38','0000-00-00 00:00:00');;;
-- -------------------------------------------
...
('1','1','1','5','10th','2018','12345','505','408','A','81%','Colony High School','signed','2019-06-27 15:43:23','0000-00-00 00:00:00','1','0','1');;;
INSERT INTO `std_academic_info` (`academic_id`,`std_id`,`class_name_id`,`subject_combination`,`previous_class`,`passing_year`,`previous_class_rollno`,`total_marks`,`obtained_marks`,`grades`,`percentage`,`Institute`,`std_enroll_status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('2','2','5','9','','','','','','','','Colony High School','unsign','2019-06-27 12:23:47','0000-00-00 00:00:00','1','0','1');;;
INSERT INTO `std_academic_info` (`academic_id`,`std_id`,`class_name_id`,`subject_combination`,`previous_class`,`passing_year`,`previous_class_rollno`,`total_marks`,`obtained_marks`,`grades`,`percentage`,`Institute`,`std_enroll_status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('3','3','1','5','','','','','','','','National Garrison ','unsign','2019-06-27 14:42:20','0000-00-00 00:00:00','1','0','1');;;
INSERT INTO `std_academic_info` (`academic_id`,`std_id`,`class_name_id`,`subject_combination`,`previous_class`,`passing_year`,`previous_class_rollno`,`total_marks`,`obtained_marks`,`grades`,`percentage`,`Institute`,`std_enroll_status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('4','4','1','5','','','','','','','','National Garrison ','unsign','2019-06-27 12:23:40','0000-00-00 00:00:00','1','0','1');;;
INSERT INTO `std_academic_info` (`academic_id`,`std_id`,`class_name_id`,`subject_combination`,`previous_class`,`passing_year`,`previous_class_rollno`,`total_marks`,`obtained_marks`,`grades`,`percentage`,`Institute`,`std_enroll_status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('5','5','1','14','6th','2018','12345','505','408','A','81%','National Garrison ','unsign','2019-06-27 12:23:35','0000-00-00 00:00:00','4','0','1');;;
INSERT INTO `std_academic_info` (`academic_id`,`std_id`,`class_name_id`,`subject_combination`,`previous_class`,`passing_year`,`previous_class_rollno`,`total_marks`,`obtained_marks`,`grades`,`percentage`,`Institute`,`std_enroll_status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('6','6','2','14','6th','2019','265641','1100','880','A','80%','Colony High School','unsign','2019-06-26 06:40:10','0000-00-00 00:00:00','4','0','1');;;
INSERT INTO `std_academic_info` (`academic_id`,`std_id`,`class_name_id`,`subject_combination`,`previous_class`,`passing_year`,`previous_class_rollno`,`total_marks`,`obtained_marks`,`grades`,`percentage`,`Institute`,`std_enroll_status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('7','7','2','14','6th','2019','265641','505','408','A','81%','Colony High School','unsign','2019-06-26 06:40:14','0000-00-00 00:00:00','4','0','1');;;
INSERT INTO `std_academic_info` (`academic_id`,`std_id`,`class_name_id`,`subject_combination`,`previous_class`,`passing_year`,`previous_class_rollno`,`total_marks`,`obtained_marks`,`grades`,`percentage`,`Institute`,`std_enroll_status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('8','8','2','14','6th','2018','12345','505','408','A','81%','Colony High School','unsign','2019-06-26 06:40:18','0000-00-00 00:00:00','4','0','1');;;
INSERT INTO `std_academic_info` (`academic_id`,`std_id`,`class_name_id`,`subject_combination`,`previous_class`,`passing_year`,`previous_class_rollno`,`total_marks`,`obtained_marks`,`grades`,`percentage`,`Institute`,`std_enroll_status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('9','9','5','9','','','','','','','','','unsign','2019-06-25 06:18:04','0000-00-00 00:00:00','1','0','1');;;
-- -------------------------------------------
...
-- -------------------------------------------
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('1','5','KG-1','KG-1','School','Active','2019-03-16 06:27:49','2019-03-16 06:27:49','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('2','5','Nursery','Nursery','School','Active','2019-03-16 06:28:12','2019-03-16 06:28:12','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('3','5','Prep','Prep','School','Active','2019-03-16 06:28:25','2019-03-16 06:28:25','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('4','5','One','One','School','Active','2019-03-16 06:28:33','2019-03-16 06:28:33','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('5','5','Two','Two','School','Active','2019-03-16 06:28:45','2019-03-16 06:28:45','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('6','5','Three','Three','School','Active','2019-03-16 06:28:56','2019-03-16 06:28:56','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('7','5','Four','Four','School','Active','2019-03-16 06:29:09','2019-03-16 06:29:09','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('8','5','5th','5th','School','Active','2019-03-18 10:31:59','2019-03-16 06:29:26','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('9','6','6th','6th','School','Active','2019-03-18 10:30:32','2019-03-16 06:29:36','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('11','6','7th','7th','School','Active','2019-03-18 10:45:19','2019-03-18 10:45:19','1','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('12','6','8th ','8th ','School','Active','2019-03-18 10:45:28','2019-03-18 10:45:28','3','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('13','6','9th','9th','School','Active','2019-03-18 10:45:36','2019-03-18 10:45:36','3','1','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('14','6','10th','10th','School','Inactive','2019-04-20 13:12:28','2019-04-20 13:12:28','1','3','1');;;
INSERT INTO `std_class_name` (`class_name_id`,`branch_id`,`class_name`,`class_name_description`,`class_type`,`status`,`created_at`,`updated_at`,`created_by`,`updated_by`,`delete_status`) VALUES
('16','5','Play Group','Play Group','School','Active','2019-03-20 10:02:23','0000-00-00 00:00:00','4','0','1');;;
-- -------------------------------------------
...
('1','1','STD-Y19-1','KG--Re19-1','1','Anas','2019-06-27 15:43:23','0000-00-00 00:00:00','1','0','1');;;
-- -------------------------------------------
...
('1','5','1','4','1','KG-1-2019 - 2020 -Red','2019-06-27 15:43:23','0000-00-00 00:00:00','1','0','1');;;
-- -------------------------------------------
