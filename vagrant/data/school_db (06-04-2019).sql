...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2019 at 08:07 AM
...
(4, 2, 1, 3000, 0, '2019-04-04 17:47:54', '0000-00-00 00:00:00', 0, 0, 1),
(5, 2, 2, 2000, 0, '2019-04-04 17:47:54', '0000-00-00 00:00:00', 0, 0, 1),
(6, 2, 7, 200, 0, '2019-04-04 17:47:54', '0000-00-00 00:00:00', 0, 0, 1),
...
(11, 5, 2, 2000, 0, '2019-04-04 17:53:28', '0000-00-00 00:00:00', 0, 0, 1),
...
INSERT INTO `fee_transaction_head` (`fee_trans_id`, `branch_id`, `class_name_id`, `session_id`, `section_id`, `std_id`, `std_name`, `month`, `transaction_date`, `total_amount`, `total_discount`, `paid_amount`, `remaining`, `status`, `created_at`, `updated_at`, `created_by`, `updated_by`, `delete_status`) VALUES
(1, 5, 1, 4, 3, 5, 'Aniqa Gull', '2019-04', '2019-04-04 00:00:00', 5010, 0, 5010, 0, 'Paid', '2019-04-04 17:52:45', '0000-00-00 00:00:00', 1, 0, 1),
(2, 5, 1, 4, 3, 8, 'Sadia Gull', '2019-04', '2019-04-04 00:00:00', 5200, 0, 0, 0, 'Unpaid', '2019-04-04 17:47:54', '0000-00-00 00:00:00', 1, 0, 1),
(3, 5, 1, 4, 3, 18, 'Asra', '2019-04', '2019-04-04 00:00:00', 5300, 0, 0, 0, 'Unpaid', '2019-04-04 17:47:54', '0000-00-00 00:00:00', 1, 0, 1),
(4, 5, 1, 4, 3, 5, 'Aniqa Gull', '2019-05', '2019-05-07 00:00:00', 1955, 0, 0, 0, 'Unpaid', '2019-04-04 17:53:28', '0000-00-00 00:00:00', 1, 0, 1),
(5, 5, 1, 4, 3, 8, 'Sadia Gull', '2019-05', '2019-05-07 00:00:00', 2000, 0, 0, 0, 'Unpaid', '2019-04-04 17:53:28', '0000-00-00 00:00:00', 1, 0, 1),
(6, 5, 1, 4, 3, 18, 'Asra', '2019-05', '2019-05-07 00:00:00', 2000, 0, 0, 0, 'Unpaid', '2019-04-04 17:53:28', '0000-00-00 00:00:00', 1, 0, 1);
...
(10, 14, 2, 6, '10th', 0, 12345, 111, 111, 'A+', '100%', 'Colony High School', 'signed', '2019-04-04 17:18:16', '0000-00-00 00:00:00', 1, 0, 1),
(11, 18, 1, 5, '10th', 2018, 12345, 1100, 880, 'A', '80%', 'National Garrison ', 'signed', '2019-04-04 17:11:10', '0000-00-00 00:00:00', 1, 0, 1),
...
(5, 2, 'STD-Y19-15', 'KG--Gr19-3', 18, 'Asra', '2019-04-04 17:11:09', '0000-00-00 00:00:00', 1, 0, 1),
(6, 3, 'STD-Y19-13', 'Nur-Re19-1', 14, 'Testing 1', '2019-04-04 17:18:16', '0000-00-00 00:00:00', 1, 0, 1),
(7, 3, 'STD-Y19-53', 'Nur-Re19-2', 53, 'M. Azaan', '2019-04-04 17:18:16', '0000-00-00 00:00:00', 1, 0, 1);
...
(3, 5, 2, 4, 1, 'Nursery-2019 - 2020 -Red', '2019-04-04 17:18:16', '0000-00-00 00:00:00', 1, 0, 1);
...
--
ALTER TABLE `fee_transaction_detail`
  MODIFY `fee_trans_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `std_academic_info`
  MODIFY `academic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `std_enrollment_detail`
  MODIFY `std_enroll_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `std_guardian_info`
  MODIFY `std_guardian_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `std_ice_info`
--
ALTER TABLE `std_ice_info`
  MODIFY `std_ice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `std_personal_info`
  MODIFY `std_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
